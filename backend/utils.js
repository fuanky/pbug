...
const classNameMap = {
  'Attach': {
    'Weapon': {
      ...
      'Upper': {
        ...
        'Scope':              ['3Ｘ', 0b00000000001000000000000000000000],//NO date
        'Scope6':             ['6Ｘ', 0b00000000001000000000000000000000],//NO date
  ...
  'Weapon': {
    ...
    'SLR':                    ['ＳLＲ',   0b00000000000000000000000000000000], //NO date
  ...
  'Boost': {
    ...
    'Adrenaline':             ['肾素',     0b00000000000000000000000001000000] //NO date
    },
  'Heal': {
